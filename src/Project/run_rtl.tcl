...
if { $list_projs eq "" } {
   create_project RTL RTL -part xczu7ev-ffvc1156-2-e
...
# CHECK IPs
##################################################################
set_property  ip_repo_paths ./HLS/Baseline/impl/ip [current_project]
update_ip_catalog

set bCheckIPs 1
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:SkyNet:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: CLKWIZ_connect, and set properties
  set CLKWIZ_connect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 CLKWIZ_connect ]
  ...
  # Create instance: SkyNet_connect, and set properties
  set SkyNet_connect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 SkyNet_connect ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {175.682} \
   CONFIG.CLKOUT2_PHASE_ERROR {317.963} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100.000} \
   CONFIG.CLKOUT2_USED {false} \
   CONFIG.CLKOUT3_JITTER {141.021} \
   CONFIG.CLKOUT3_PHASE_ERROR {269.383} \
  ...
  # Create instance: rst_pe_100M, and set properties
  set rst_pe_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_pe_100M ]
  ...
  connect_bd_intf_net -intf_net SkyNet_0_m_axi_bm [get_bd_intf_pins SkyNet/m_axi_bm] [get_bd_intf_pins smartconnect_3/S00_AXI]
  connect_bd_intf_net -intf_net SkyNet_0_m_axi_fm [get_bd_intf_pins SkyNet/m_axi_fm] [get_bd_intf_pins smartconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net SkyNet_0_m_axi_wt [get_bd_intf_pins SkyNet/m_axi_wt] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net SkyNetc_connect_M00_AXI [get_bd_intf_pins SkyNet/s_axi_AXILiteS] [get_bd_intf_pins SkyNet_connect/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins CLKWIZ_connect/M00_AXI] [get_bd_intf_pins clk_wiz_0/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins CLKWIZ_connect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins SkyNet_connect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins CLKWIZ_connect/ARESETN] [get_bd_pins rst_pe_100M/interconnect_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SkyNet/ap_clk] [get_bd_pins SkyNet_connect/ACLK] [get_bd_pins SkyNet_connect/M00_ACLK] [get_bd_pins SkyNet_connect/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_3/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins SkyNet_connect/ARESETN] [get_bd_pins SkyNet_connect/M00_ARESETN] [get_bd_pins SkyNet_connect/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins SkyNet/ap_rst_n] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_3/aresetn]
  connect_bd_net -net rst_pe_100M_peripheral_aresetn [get_bd_pins CLKWIZ_connect/M00_ARESETN] [get_bd_pins CLKWIZ_connect/S00_ARESETN] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins rst_pe_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins CLKWIZ_connect/ACLK] [get_bd_pins CLKWIZ_connect/M00_ACLK] [get_bd_pins CLKWIZ_connect/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins rst_pe_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins rst_pe_100M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_bm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP3_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SkyNet/Data_m_axi_bm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_QSPI] SEG_zynq_ultra_ps_e_0_HP3_QSPI
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs clk_wiz_0/s_axi_lite/Reg] SEG_clk_wiz_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_bm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP3_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_bm/SEG_zynq_ultra_ps_e_0_HP3_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_fm/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_wt/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
...
create_root_design ""
make_wrapper -files [get_files ./RTL/RTL.srcs/sources_1/bd/zcu104/zcu104.bd] -top
add_files -norecurse ./RTL/RTL.srcs/sources_1/bd/zcu104/hdl/zcu104_wrapper.v
